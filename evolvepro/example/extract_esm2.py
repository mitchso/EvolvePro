...
from evolvepro.plm.extract_esm2 import *

extract_embeddings(model='esm2_t36_3B_UR50D',
                   fasta_files=['outputs/WT.fasta', 'outputs/single_mutants.fasta'],    # make sure to include the wild-type sequence as well
                   output_csv=f'outputs/embeddings_esm2_3b.csv',
                   seqs_per_batch=8)